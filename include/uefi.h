...
// SMBIOS 3.0+ "entry point" (table pointer)
...
static const EFI_GUID EFI_acpi20_table_guid = EFI_ACPI_TABLE_GUID;
static const EFI_GUID EFI_mps_table_guid = MPS_TABLE_GUID;
static const EFI_GUID EFI_smbios3_table_guid = SMBIOS3_TABLE_GUID;
...
typedef struct {
    ...
    UINTN                            NumberOfTableEntries; // ... in config table
