...
const EFI_GUID EFI_loaded_image_protocol_guid = EFI_LOADED_IMAGE_PROTOCOL_GUID;
const EFI_GUID EFI_loaded_image_device_path_protocol_guid = EFI_LOADED_IMAGE_DEVICE_PATH_PROTOCOL_GUID;
